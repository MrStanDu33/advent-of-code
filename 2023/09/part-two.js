 ...
 * of them and we get first values based on extrapolated values. We then sum
 * them to get the answer.
 *
 * @returns { Promise<void> }
 */
const main = async () => {
  Logger.info('Start running 2023 / 09 - part two test');
